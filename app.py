...
# --- 3. FastAPI App ---
##Need To Code
app=FastAPI(title="Movie and wheather agent", version='1.0", description="A langchain agent (Gemini) with search_movies and get_weather tools,served via LangServe.")
@app.get("/")
def root():
